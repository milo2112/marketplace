                ...
                <section className="text-center" style={{ paddingTop: '50px', paddingLeft: '350px' }}>
                    <div className="row  mb-1">
                        <div className="col-lg-3 col-md-6 mb-5 mb-md-5 mb-lg-0 position-relative">
                            ...
                            <h5 className="text-secondary fw-bold mb-3" style={{ fontFamily: 'Barrio', fontSize: '20px' }}>5 🎯</h5>
                        ...
                        <div className="col-lg-3 col-md-6 mb-5 mb-md-5 mb-lg-0 position-relative">
                            <i className="fas fa-image fa-3x text-primary mb-4"></i>
                            <h5 className="text-secondary fw-bold mb-3" style={{ fontFamily: 'Barrio', fontSize: '20px' }}>+ 10 🗺️</h5>
                        ...
                        <div className="col-lg-3 col-md-6 mb-5 mb-md-5 mb-lg-0 position-relative">
                            <i className="fas fa-image fa-3x text-primary mb-4"></i>
                            <h5 className="text-secondary fw-bold mb-3" style={{ fontFamily: 'Barrio', fontSize: '20px' }}>+ 10 🛌🏼</h5>
